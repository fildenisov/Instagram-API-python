...
class InstagramAPI:
    ...
    DEVICE_SETTINTS = {'manufacturer': 'Xiaomi',
                       ...
                       'android_version': 18,
                       'android_release': '4.3'}
    USER_AGENT = 'Instagram 10.34.0 Android ({android_version}/{android_release}; 320dpi; 720x1280; {manufacturer}; {model}; armani; qcom; en_US)'.format(
        **DEVICE_SETTINTS)
    ...
    def direct_photo_by_url(self, url, recipients, upload_id=None):
        ...
        data = {
            ...
            'thread': '["0"]',
            'photo': ('pending_media_%s.jpg' % upload_id, img, 'application/octet-stream',
                      {'Content-Transfer-Encoding': 'binary'})
        }
